...
function Contact() {
  const socials = [
    { name: "Facebook", url: "https://www.facebook.com/kheops.set", icon: Facebook },
    ...
    <footer className="w-full max-w-[1600px] mx-auto pt-24 pb-12 px-4 md:px-8 flex flex-col gap-12 border-t border-white/5 mt-12">
        ...
        <div className="md:col-span-6 flex flex-wrap gap-12 md:justify-end">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2 text-[10px] uppercase tracking-widest text-white/40">
              <Link href="#accueil" onClick={() => gtag.event({ action: 'nav_footer', category: 'navigation', label: 'Accueil' })} className="hover:text-gold transition-colors">Accueil</Link>
              <Link href="#manifeste" onClick={() => gtag.event({ action: 'nav_footer', category: 'navigation', label: 'Manifeste' })} className="hover:text-gold transition-colors">Manifeste</Link>
              <Link href="#arsenal" onClick={() => gtag.event({ action: 'nav_footer', category: 'navigation', label: 'Arsenal' })} className="hover:text-gold transition-colors">Arsenal</Link>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2 text-[10px] uppercase tracking-widest text-white/40">
              <a href="https://www.facebook.com/kheops.set" target="_blank" rel="noopener noreferrer" aria-label="Facebook Kheops Set Motivation" onClick={() => gtag.event({ action: 'social_footer', category: 'social', label: 'Facebook' })} className="hover:text-gold transition-colors">Facebook</a>
              <a href="https://wa.me/237654172703" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp Kheops Set Motivation" onClick={() => gtag.event({ action: 'social_footer', category: 'social', label: 'WhatsApp' })} className="hover:text-gold transition-colors">WhatsApp</a>
              <a href="https://www.youtube.com/@kheopset.motivation" target="_blank" rel="noopener noreferrer" aria-label="YouTube Kheops Set Motivation" onClick={() => gtag.event({ action: 'social_footer', category: 'social', label: 'YouTube' })} className="hover:text-gold transition-colors">YouTube</a>
              <a href="https://www.instagram.com/kheopset.motivation" target="_blank" rel="noopener noreferrer" aria-label="Instagram Kheops Set Motivation" onClick={() => gtag.event({ action: 'social_footer', category: 'social', label: 'Instagram' })} className="hover:text-gold transition-colors">Instagram</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center pt-12 border-t border-white/5 gap-6">
        ...
        <div className="flex gap-8 text-[8px] uppercase tracking-widest text-white/30">
          <Link href="/mentions-legales" onClick={() => gtag.event({ action: 'nav_legal', category: 'navigation', label: 'Mentions Légales' })} className="hover:text-white transition-colors">Mentions Légales</Link>
          <Link href="/politique-de-confidentialite" onClick={() => gtag.event({ action: 'nav_legal', category: 'navigation', label: 'Politique de Confidentialité' })} className="hover:text-white transition-colors">Politique de Confidentialité</Link>
        </div>
      </div>
    </footer>
  );
